...
public class NPC_jenna : MonoBehaviour {
	...
	public void PlayDialog(){
		if (readyToBattle) {
			...
			BattleScreen.S.enemyName = "GYM RAT JENNA";
			Pokemon pkm = new Pokemon ("JIGGLYPUFF", "JIGGY", 35, 23, 7, 13, 10, 10, 7, "NORMAL", "");
			pkm.moves = new List<Move>();
			pkm.moves.Add (Move.getMove("POUND"));
			pkm.moves.Add (Move.getMove("TAIL WHIP"));
			Pokemon pkm2 = new Pokemon ("ODDISH", "ODDITY", 35, 23, 9, 13, 10, 10, 11, "GRASS", "POISON");
			pkm2.moves = new List<Move>();
			pkm2.moves.Add (Move.getMove("TACKLE"));
			pkm2.moves.Add (Move.getMove("VINE WHIP"));
