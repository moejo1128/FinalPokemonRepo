...
public class NPC_kim : MonoBehaviour {
	...
	public void PlayDialog(){
		if (readyToBattle) {
			...
			BattleScreen.S.enemyName = "GYM RAT KIM";
			
			Pokemon pkm1 = new Pokemon ("RATTATA", "HERB", 30, 19, 5, 12, 10, 10, 7, "NORMAL", "");
			pkm1.moves = new List<Move>();
			pkm1.moves.Add (Move.getMove("TACKLE"));
			pkm1.moves.Add (Move.getMove("TAIL WHIP"));
			Pokemon pkm2 = new Pokemon ("RATTICATE", "MOMO", 44, 20, 8, 13, 10, 10, 7, "NORMAL", "");
			pkm2.moves = new List<Move>();
			pkm2.moves.Add (Move.getMove("SCRATCH"));
			pkm2.moves.Add (Move.getMove("TAIL WHIP"));
			pkm2.moves.Add (Move.getMove("HYPER FANG"));
			Pokemon pkm3 = new Pokemon ("RAPIDASH", "RORY", 45, 78, 8, 15, 12, 13, 14, "FIRE", "");
			pkm3.moves = new List<Move>();
			pkm3.moves.Add (Move.getMove("TACKLE"));
			pkm3.moves.Add (Move.getMove("TAIL WHIP"));
			pkm3.moves.Add (Move.getMove("EMBER"));
