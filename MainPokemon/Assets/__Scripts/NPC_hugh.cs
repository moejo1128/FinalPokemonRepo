...
public class NPC_hugh : MonoBehaviour {
	...
	void initBattle(){
		...
		Pokemon pkm1 = new Pokemon ("PSYDUCK", "DUCKY", 36, 52, 8, 8, 8, 11, 12, "WATER", "");
		pkm1.moves = new List<Move>();
		pkm1.moves.Add (Move.getMove("WATER GUN"));
		pkm1.moves.Add (Move.getMove("CONFUSION"));
		Pokemon pkm2 = new Pokemon ("GOLDUCK", "GOLDY", 44, 25, 9, 8, 11, 11, 13, "WATER", "");
		pkm2.moves = new List<Move>();
		pkm2.moves.Add (Move.getMove("WATER GUN"));
		pkm2.moves.Add (Move.getMove("CONFUSION"));
		pkm2.moves.Add (Move.getMove("PSYCHIC"));
