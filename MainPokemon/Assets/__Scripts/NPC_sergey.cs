...
public class NPC_sergey : MonoBehaviour {
	...
	public void PlayDialog(){
		if (readyToBattle) {
			...
			BattleScreen.S.enemyName = "YOUNGSTER SERGEY";
			Pokemon pkm = new Pokemon ("PIDGEY", "JOJO", 35, 23, 7, 13, 10, 10, 7, "NORMAL", "FLYING");
			pkm.moves = new List<Move>();
			pkm.moves.Add (Move.getMove("GUST"));
			pkm.moves.Add (Move.getMove("TAIL WHIP"));
			Pokemon pkm2 = new Pokemon ("RATTATA", "MIMI", 35, 23, 7, 13, 10, 10, 7, "NORMAL", "");
			pkm2.moves = new List<Move>();
			pkm2.moves.Add (Move.getMove("SCRATCH"));
			pkm2.moves.Add (Move.getMove("TAIL WHIP"));
			Pokemon pkm3 = new Pokemon ("GOLDEEN", "CECE", 40, 23, 8, 13, 10, 10, 11, "WATER", "");
			pkm3.moves = new List<Move>();
			pkm3.moves.Add (Move.getMove("TACKLE"));
			pkm3.moves.Add (Move.getMove("WATER GUN"));
